...
class MainApp(MDApp, BoxLayout):
    ...
    def on_key_press(self, window, key, *args):
        """
        ces raccourcis ne sont pas utiles sur mobile
        """
    ...
    def changer_police(self, police: str):
        ...
        screen_manager.get_screen(
            "main_screen"
        ).ids.id_kv_mot.font_name = font  # Le mot à definir
        screen_manager.get_screen(
            "main_screen"
        ).ids.id_kv_definition.font_name = font  # la delefition
    ...
    def changer_taille(self, taille):
        ...
        screen_manager.get_screen(
            "main_screen"
        ).ids.id_kv_mot.font_size = taille  # Le mot à definir
        screen_manager.get_screen(
            "main_screen"
        ).ids.id_kv_definition.font_size = taille  # la delefition
    ...
    @classmethod
    def changer_ecran(
        cls, nom_ecran: str = "main_screen", direction: str = "left"
    ) -> None:
        """
